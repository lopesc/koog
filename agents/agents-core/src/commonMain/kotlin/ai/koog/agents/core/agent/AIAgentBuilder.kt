 ...
 */
@JavaAPI
public class AIAgentBuilder internal constructor() {
    /**
     ...
     */
    @JavaAPI
    public fun promptExecutor(promptExecutor: PromptExecutor): AIAgentBuilder = apply {
        AIAgentConfig
     ...
     */
    @JavaAPI
    public fun llmModel(model: LLModel): AIAgentBuilder = apply {
        this.llmModel = model
    }
     ...
     */
    @JavaAPI
    public fun toolRegistry(toolRegistry: ToolRegistry): AIAgentBuilder = apply {
     ...
     */
    @JavaAPI
    public fun id(id: String?): AIAgentBuilder = apply {
        this.id = id
    }
     ...
     */
    @JavaAPI
    public fun systemPrompt(systemPrompt: String): AIAgentBuilder = apply {
     ...
     */
    @JavaAPI
    public fun prompt(prompt: Prompt): AIAgentBuilder = apply {
        this.prompt = prompt
    }
     ...
     */
    @JavaAPI
    public fun temperature(temperature: Double): AIAgentBuilder = apply {
     ...
     */
    @JavaAPI
    public fun numberOfChoices(numberOfChoices: Int): AIAgentBuilder = apply {
    ...
    @JavaAPI
    public fun maxIterations(maxIterations: Int): AIAgentBuilder = apply {
