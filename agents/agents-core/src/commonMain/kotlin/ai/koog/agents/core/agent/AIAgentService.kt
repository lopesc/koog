 ...
 */
public expect interface AIAgentService<Input, Output, TAgent : AIAgent<Input, Output>> {
...
public abstract class AIAgentServiceBase<Input, Output, TAgent : AIAgent<Input, Output>> :
    ...
    override suspend fun createAgentAndRun(agentInput: Input, id: String?, clock: Clock): Output =
        createAgent(id, clock).run(agentInput)
