...
public actual open class EventHandlerConfig actual constructor() : FeatureConfig() {
     ...
     */
    @JavaAPI
    public fun onAgentStarting(handler: AsyncInterceptor<AgentStartingContext>) {
        onAgentStarting { eventContext -> handler.intercept(eventContext).await() }
    }
     ...
     */
    @JavaAPI
    public fun onAgentCompleted(handler: AsyncInterceptor<AgentCompletedContext>) {
        onAgentCompleted { eventContext -> handler.intercept(eventContext).await() }
    }
     ...
     */
    @JavaAPI
    public fun onAgentExecutionFailed(handler: AsyncInterceptor<AgentExecutionFailedContext>) {
        onAgentExecutionFailed { eventContext -> handler.intercept(eventContext).await() }
    }
     ...
     */
    @JavaAPI
    public fun onAgentClosing(handler: AsyncInterceptor<AgentClosingContext>) {
        onAgentClosing { eventContext -> handler.intercept(eventContext).await() }
    }
     ...
     */
    @JavaAPI
    public fun onStrategyStarting(handler: AsyncInterceptor<StrategyStartingContext>) {
        onStrategyStarting { eventContext -> handler.intercept(eventContext).await() }
    }
     ...
     */
    @JavaAPI
    public fun onStrategyCompleted(handler: AsyncInterceptor<StrategyCompletedContext>) {
        onStrategyCompleted { eventContext -> handler.intercept(eventContext).await() }
    }
     ...
     */
    @JavaAPI
    public fun onNodeExecutionStarting(handler: AsyncInterceptor<NodeExecutionStartingContext>) {
        onNodeExecutionStarting { eventContext -> handler.intercept(eventContext).await() }
    }
     ...
     */
    @JavaAPI
    public fun onNodeExecutionCompleted(handler: AsyncInterceptor<NodeExecutionCompletedContext>) {
        onNodeExecutionCompleted { eventContext -> handler.intercept(eventContext).await() }
    }
     ...
     */
    @JavaAPI
    public fun onNodeExecutionFailed(handler: AsyncInterceptor<NodeExecutionFailedContext>) {
        onNodeExecutionFailed { eventContext -> handler.intercept(eventContext).await() }
    }
     ...
     */
    @JavaAPI
    public fun onLLMCallStarting(handler: AsyncInterceptor<LLMCallStartingContext>) {
        onLLMCallStarting { eventContext -> handler.intercept(eventContext).await() }
    }
     ...
     */
    @JavaAPI
    public fun onLLMCallCompleted(handler: AsyncInterceptor<LLMCallCompletedContext>) {
        onLLMCallCompleted { eventContext -> handler.intercept(eventContext).await() }
    }
     ...
     */
    @JavaAPI
    public fun onToolCallStarting(handler: AsyncInterceptor<ToolCallStartingContext>) {
        onToolCallStarting { eventContext -> handler.intercept(eventContext).await() }
    }
     ...
     */
    @JavaAPI
    public fun onToolValidationFailed(handler: AsyncInterceptor<ToolValidationFailedContext>) {
        onToolValidationFailed { eventContext -> handler.intercept(eventContext).await() }
    }
     ...
     */
    @JavaAPI
    public fun onToolCallFailed(handler: AsyncInterceptor<ToolCallFailedContext>) {
        onToolCallFailed { eventContext -> handler.intercept(eventContext).await() }
    }
     ...
     */
    @JavaAPI
    public fun onToolCallCompleted(handler: AsyncInterceptor<ToolCallCompletedContext>) {
        onToolCallCompleted { eventContext -> handler.intercept(eventContext).await() }
    }
     ...
     */
    @JavaAPI
    public fun onLLMStreamingStarting(handler: AsyncInterceptor<LLMStreamingStartingContext>) {
        onLLMStreamingStarting { eventContext -> handler.intercept(eventContext).await() }
    }
     ...
     */
    @JavaAPI
    public fun onLLMStreamingFrameReceived(handler: AsyncInterceptor<LLMStreamingFrameReceivedContext>) {
        onLLMStreamingFrameReceived { eventContext -> handler.intercept(eventContext).await() }
    }
     ...
     */
    @JavaAPI
    public fun onLLMStreamingFailed(handler: AsyncInterceptor<LLMStreamingFailedContext>) {
        onLLMStreamingFailed { eventContext -> handler.intercept(eventContext).await() }
    }
     ...
     */
    @JavaAPI
    public fun onLLMStreamingCompleted(handler: AsyncInterceptor<LLMStreamingCompletedContext>) {
        onLLMStreamingCompleted { eventContext -> handler.intercept(eventContext).await() }
    }
